...
const MyApplications = () => {
    ...
    const showApproveDocument = (currentDocument) => {
        ...
        setComment({
            recipientFirstname:currentDocument.RSB_Approval.reviewer.firstname,
            recipientLastname:currentDocument.RSB_Approval.reviewer.lastname,
            receiver:currentDocument.RSB_Approval.reviewer._id,
