...
const Dashboard = () => {
    ...
    useEffect(async () => {
        ...
        try {
            const response = await axios.get("http://localhost:5000/api/document/rabstatistics", config);
            const responseMonthly = await axios.get("http://localhost:5000/api/document/rabstatistics/eachmonth", config);
