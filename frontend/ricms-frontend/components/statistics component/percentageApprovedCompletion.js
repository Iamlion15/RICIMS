...
const PercentageApprovedDocuments = ({ percentage }) => {
    ...
    <>
      <div style={{ position: 'relative', width: '300px', height: '300px' }}>
        <div style={{ position: 'absolute', bottom: '100px', left: '50%', transform: 'translateX(-50%)', textAlign: 'center' }}>
          ...
          <p style={{ fontWeight: "bold", fontSize: "1.9em", margin: 0 }}>{percentage.dataPresent === true ? <span style={{fontSize:"0.7em"}}>documents</span> : "No Data"}</p>
        </div>
...
export default PercentageApprovedDocuments;
